...
hi Normal guifg=#eeeeee guibg=#282828
...
hi LineNr		guifg=#555753 guibg=#101010
hi NonText		guifg=#555753 guibg=#101010
...
hi VertSplit	guifg=#3B3B3C guibg=#3B3B3C gui=none
hi StatusLine   guifg=#FFFFFF guibg=#3B3B3C gui=none
hi StatusLineNC guifg=#808080 guibg=#3B3B3C gui=none
