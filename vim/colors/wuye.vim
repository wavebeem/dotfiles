...
hi Title	gui=BOLD guifg=#1E90FF guibg=BG		cterm=BOLD ctermfg=blue ctermbg=black
...
hi Identifier	gui=NONE guifg=#00BFFF guibg=BG		cterm=NONE ctermfg=cyan ctermbg=black
  hi Function	gui=BOLD guifg=#00CED1 guibg=BG		cterm=NONE ctermfg=cyan ctermbg=black
hi Statement	gui=NONE guifg=#54FF9F guibg=BG		cterm=NONE ctermfg=green ctermbg=black
  hi Conditional	gui=NONE guifg=#54FF9F guibg=BG	cterm=NONE ctermfg=green ctermbg=black
  hi Repeat	gui=NONE guifg=#00FF7F guibg=BG		cterm=NONE ctermfg=green ctermbg=black
  hi Label	gui=NONE guifg=#54FF9F guibg=BG		cterm=NONE ctermfg=green ctermbg=black
  hi Operator	gui=BOLD guifg=#00FA9A guibg=BG		cterm=NONE ctermfg=green ctermbg=black
  hi Keyword	gui=NONE guifg=#98FB98 guibg=BG		cterm=NONE ctermfg=green ctermbg=black
  hi Exception	gui=NONE guifg=#3CB371 guibg=BG		cterm=NONE ctermfg=green ctermbg=black
hi PreProc	gui=NONE guifg=#8470FF guibg=BG		cterm=NONE ctermfg=magenta ctermbg=black
  hi include	gui=none guifg=#8A2BE2 guibg=BG		cterm=NONE ctermfg=magenta ctermbg=black
  hi Define	gui=NONE guifg=#8470FF guibg=BG		cterm=NONE ctermfg=magenta ctermbg=black
  hi Macro	gui=NONE guifg=#8470FF guibg=BG		cterm=NONE ctermfg=magenta ctermbg=black
  hi PreCondit	gui=BOLD guifg=#6A5ACD guibg=BG		cterm=NONE ctermfg=magenta ctermbg=black
...
hi Error	gui=NONE guifg=#F0E68C guibg=#FF00FF	cterm=NONE ctermfg=yellow ctermbg=magenta
